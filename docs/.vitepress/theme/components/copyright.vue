<template>
	<div class="warning custom-block copyright" style="margin-bottom: 50px;" @click="handleClick">
		<p class="custom-block-title">
			<font style="vertical-align: inherit"><font style="vertical-align: inherit">版权声明(Creative Commons Attribution 4.0 International License)</font></font>
		</p>
		<p>
			<font style="vertical-align: inherit">您可以自由地共享和演绎本(文)作品，但需遵循以下条件： </font>
		</p>
		<p>
